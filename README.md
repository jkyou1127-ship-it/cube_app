...
3x3 큐브 연습을 위한 모바일 우선 웹 앱입니다. 스크램블 생성, 터치 타이머, 기록/통계, OLL·PLL 공식 학습을 제공합니다.
...
src/
  ...
  features/
    ...
    algorithms/
      AlgorithmsScreen.tsx      OLL/PLL 탭, 검색
      ollData.ts, pllData.ts    57 OLL + 21 PLL 데이터
      CubeDiagram.tsx           SVG 큐브 픽토그램
      AlgCard.tsx               공식 카드 (복사 버튼)
public/
...
- **OLL/PLL 학습 탭**: 57 OLL + 21 PLL, SVG 픽토그램과 함께 검색/필터. 공식은 학습 참고용으로 정리한 것으로,
  실전 연습 전 다른 정식 자료와 대조를 권장합니다(앱 내 배너로도 안내).
